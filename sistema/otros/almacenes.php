   ...
   <nav class="black">
    <div class="nav-wrapper">
      <div class="col s12">
        ...
        <a href="#!" class="breadcrumb">Almacenes</a>
      </div>
    </div>
  </nav>
  </div>
 <div>
    ...
    <div class="card">
      <div class="card-comtainer">
        <div class="col s12">
          <h1><i class="large material-icons left">widgets</i>Almacenes</h1>
        </div>
        <div class="col s12">
          <div class="card">
            <div class="col s2">
              <div class="card center">
                <div class="card-content green darken-3">
                    <a href="./crearAlmacen.php" class="white-text"><i class="medium material-icons">add</i></a>
                    <p class="white-text">Crear Almacen</p>
                  </div>
              </div>
            </div>
