  ...
  <div class="">
    ...
    <div class="card">
      <div class="card-comtainer">
        <div class="col s12">
          <h1><i class="large material-icons left">assignment_ind</i>Proveedores</h1>
        </div>
        <div class="col s12">
          <div class="card">
            <div class="col s2">
              <div class="card center">
                <div class="card-content light-blue darken-1">
                    <a href="./altaProveedor.php" class="white-text"><i class="medium material-icons">add</i></a>
                    <p class="white-text">Registrar Provedor</p>
                  </div>
              </div>
            </div>
