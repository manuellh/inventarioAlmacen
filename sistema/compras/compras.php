      ...
      <div class="card">
        <div class="card-content blue">
          <div class="row">
            ...
            <div class="col s7">
              <h3 class="right-align white-text">Meter Articulos al Almacen</h3>
            </div>
          </div>
        </div>
        <div class="card-action">
          <a href="comprar.php" class="blue-text">Meter Articulos al Almacen<i class="material-icons right">navigate_next</i></a>
        </div>
      </div>
    </div>
      ...
      <div class="card">
        <div class="card-content amber">
          <div class="row">
            ...
            <div class="col s7">
              <h3 class="right-align white-text">Articulos Almacenados Recientemente</h3>
            </div>
          </div>
        </div>
        <div class="card-action">
          <a href="comprasRealizadas.php" class="aber-text">Ver Detalles<i class="material-icons right">navigate_next</i></a>
        </div>
      </div>
    </div>
